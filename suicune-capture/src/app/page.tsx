...
function PseudoScreen({ pseudo, setPseudo, onConfirm, cfg }: {
  ...
  return (
    <div className="lobby-bg h-dvh w-full flex flex-col items-center justify-center p-6 text-center">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: "easeOut" }} className="relative w-full max-w-sm">
    ...
    <div className="lobby-bg h-dvh w-full flex flex-col items-center justify-center p-6 text-center">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="relative">
        ...
        <p className="text-xs text-white/25">
          Taux de capture : <span className="font-semibold" style={{ color: `${cfg.accentColorHex}80` }}>0.5%</span> — Bonne chance.
        </p>
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-white/30 mt-1">
            Taux de capture : <span className="font-mono font-semibold" style={{ color: `${cfg.accentColorHex}80` }}>0.5%</span>
